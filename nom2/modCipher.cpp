...
inline int modCipher::getValidKey(const int k, const std::wstring & s)
{
	if (k<=0)
...
inline std::wstring modCipher::getValidOpenText(const std::wstring & s)
{
	int i=0;
	std::wstring tmp;
	for (auto c:s) {
...
inline std::wstring modCipher::getValidCipherText(const std::wstring & s)
{
	int i=0;
	std::wstring tmp;
	for (auto c:s) {
